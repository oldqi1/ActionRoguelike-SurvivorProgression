...
void URogueProjectilesSubsystem::SpawnImpactFX(const UWorld* World, const FProjectileItem& ProjConfig, FVector ImpactPosition, FRotator ImpactRotation)
{
	...
	{
		// UE 5.7 changed/removed the Niagara Data Channel library API used by this sample.
		// Keep impact VFX enabled above and skip the experimental decal data-channel path.
	}
}
